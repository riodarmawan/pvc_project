            ...
            <div class="hidden md:flex items-center gap-2">
              ...
              @auth
                ...
                @if ((int)auth()->user()->role_id === 1)
                  <a href="{{ route('accounting.chart') }}" class="inline-flex items-center gap-2 h-10 px-3 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 transition">
                    <svg viewBox="0 0 20 20" class="h-4 w-4 text-teal-600">
                      <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"></path>
                      <path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd"></path>
                    </svg>
                    <span class="font-medium">Akuntansi</span>
                  </a>
                  <a href="{{ route('accounting.journal') }}" class="inline-flex items-center gap-2 h-10 px-3 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 transition">
                    <svg viewBox="0 0 20 20" class="h-4 w-4 text-cyan-600">
                      <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clip-rule="evenodd"></path>
                    </svg>
                    <span class="font-medium">Jurnal</span>
                  </a>
                  <a href="{{ route('reports.income_statement') }}" class="inline-flex items-center gap-2 h-10 px-3 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 transition">
                    <svg viewBox="0 0 20 20" class="h-4 w-4 text-orange-600">
          ...
          <div class="mt-2 rounded-2xl border border-slate-200 bg-white shadow-card overflow-hidden">
            ...
            <div class="p-2 grid gap-2">
              ...
              @auth
                ...
                @if ((int)auth()->user()->role_id === 1)
                  <a href="{{ route('accounting.chart') }}" class="inline-flex items-center gap-2 h-11 px-3 rounded-xl border border-slate-200 hover:bg-slate-50">
                    <svg viewBox="0 0 20 20" class="h-4 w-4 text-teal-600">
                      <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"></path>
                      <path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd"></path>
                    </svg>
                  ...
                  <a href="{{ route('accounting.journal') }}" class="inline-flex items-center gap-2 h-11 px-3 rounded-xl border border-slate-200 hover:bg-slate-50">
                    <svg viewBox="0 0 20 20" class="h-4 w-4 text-cyan-600">
                      <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clip-rule="evenodd"></path>
                    </svg>
                    Jurnal
                  </a>
                  <a href="{{ route('reports.income_statement') }}" class="inline-flex items-center gap-2 h-11 px-3 rounded-xl border border-slate-200 hover:bg-slate-50">
                    <svg viewBox="0 0 20 20" class="h-4 w-4 text-orange-600">
                      <path fill-rule="evenodd" d="M3 3a1 1 0 000 2v8a2 2 0 002 2h2.586l-1.293 1.293a1 1 0 101.414 1.414L10 15.414l2.293 2.293a1 1 0 001.414-1.414L12.414 15H15a2 2 0 002-2V5a1 1 0 100-2H3zm11.707 4.707a1 1 0 00-1.414-1.414L10 9.586 8.707 8.293a1 1 0 00-1.414 0l-2 2a1 1 0 101.414 1.414L8 10.414l1.293 1.293a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                    </svg>
                    Laba Rugi
