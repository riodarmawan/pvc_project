...
<div class="space-y-6">
 ...
 <p class="text-slate-600 ">Perbarui informasi panjang atau kondisi untuk sisa potongan ini.</p>
 </div>

 @if ($errors->any())
 <div class="rounded-xl border px-4 py-3 bg-rose-50 border-rose-200 text-rose-700 ">
 ...
 <div>
 <div class="text-xs uppercase tracking-wide text-slate-600 mb-1">Produk</div>
 <div class="font-medium">
 <span class="font-mono text-xs text-slate-600 ">[{{ $leftover->product_sku }}]</span>
 {{ $leftover->product_name }}
 </div>
 </div>
 <div>
 <div class="text-xs uppercase tracking-wide text-slate-600 mb-1">Cabang</div>
 <div class="inline-flex items-center gap-2 px-3 py-1 rounded-lg border bg-slate-100 border-slate-200 ">
 ...
 <div class="space-y-2">
 <label for="length_m" class="block text-xs uppercase tracking-wide text-slate-600 ">
 Panjang (dalam meter)
 </label>
 ...
 <div class="space-y-2">
 <label for="condition" class="block text-xs uppercase tracking-wide text-slate-600 ">
 Kondisi
 </label>
