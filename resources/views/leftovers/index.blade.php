...
<div class="space-y-6">
 ...
 <p class="text-slate-600 ">Kelola semua sisa potongan dari proyek yang telah selesai.</p>
 </div>
 ...
 <div class="font-mono text-xs text-slate-600 ">[{{ $leftover->product_sku }}]</div>
 ...
 class="inline-flex items-center h-9 px-3 rounded-lg border hover:bg-slate-100 border-slate-200 ">
 Edit
 </a>
