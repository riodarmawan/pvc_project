...
<div class="space-y-6">
    <div class="space-y-2">
        ...
        <p class="text-slate-600 dark:text-slate-400">Jejak audit gabungan dari penjualan dan invoice proyek.</p>
    </div>
    ...
    <div class="rounded-2xl border bg-white shadow-card border-slate-200 dark:bg-[#0f172a] dark:border-[rgba(148,163,184,.12)]">
        <form action="{{ route('reports.transactions.index') }}" method="GET" class="p-6 md:p-7">
            <div class="grid md:grid-cols-4 gap-4">
                ...
                {{-- Tipe Transaksi --}}
                <div>
                    <label for="type" class="block text-xs uppercase tracking-wide mb-2 text-slate-600 dark:text-slate-400">Tipe</label>
                        ...
                        @forelse ($transactions as $tx)
                            <tr class="hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                                ...
                                <td class="py-3 pr-4 align-top">
                                    ...
                                    @else
                                        <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium bg-indigo-100 text-indigo-700 dark:bg-indigo-500/15 dark:text-indigo-300">
                                            {{ $tx->transaction_type }}
                                        </span>
                                    @endif
                                </td>
                            ...
                            <tr>
                                <td colspan="6" class="py-10">
                                    <div class="text-center space-y-2">
                                        ...
                                        <p class="text-slate-600 dark:text-slate-400">Coba ubah atau reset filter yang Anda gunakan.</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
