        ...
        <div class="p-6 md:p-7">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div class="flex items-start gap-3">
                    <div class="h-10 w-10 rounded-lg bg-slate-100 border border-slate-200 flex items-center justify-center dark:bg-white/5 dark:border-[rgba(148,163,184,.12)]">
                        <svg width="24" height="24" class="h-5 w-5 text-slate-500 dark:text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.207A1 1 0 013 6.5V4z"/>
                        </svg>
                    </div>
                    <div>
                        <h3 class="text-base font-semibold">Filter & Pencarian</h3>
                        <p class="text-sm text-slate-500 dark:text-slate-400">Temukan data dengan mudah dan cepat</p>
                    </div>
                </div>
                <div>
                    <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border bg-slate-100 text-sm border-slate-200 dark:bg-white/5 dark:border-[rgba(148,163,184,.12)]">
            ...
            <div class="mt-6">
                <form action="{{ route('reports.stock.index') }}" method="GET" class="space-y-4">
                    <div class="grid md:grid-cols-2 gap-4">
                        <!-- Branch Filter -->
                        <div>
                            <label for="branch_id" class="block text-xs uppercase tracking-wide text-slate-500 dark:text-slate-400 mb-2">
                            ...
                            <div class="relative">
                                <select name="branch_id" id="branch_id"
                                        class="w-full appearance-none bg-white border border-slate-200 rounded-xl h-11 px-3 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-brand/40 dark:bg-[#0f172a] dark:border-[rgba(148,163,184,.12)]">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500 dark:text-slate-400">{{ number_format($stockData->total()) }} total item ditemukan</p>
                    </div>
                </div>
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
                                ...
                                <td class="py-3 pr-4 align-top">
                                    <div class="flex items-center gap-3">
                                        <div class="h-8 w-8 rounded-lg bg-slate-100 border border-slate-200 text-slate-600 text-xs font-semibold grid place-items-center dark:bg-white/5 dark:border-[rgba(148,163,184,.12)] dark:text-slate-300">
                                            <span>{{ substr($stock->product_sku, 0, 2) }}</span>
                                        </div>
                                        <div class="leading-tight">
                                            <code class="px-2 py-1 rounded-md bg-slate-100 border border-slate-200 text-xs dark:bg-white/5 dark:border-[rgba(148,163,184,.12)]">
                                                {{ $stock->product_sku }}
                                            </code>
                                        </div>
                                    </div>
                                ...
                                <td class="py-3 pr-4 align-top">
                                    <div>
                                        ...
                                        <div class="text-xs text-slate-500 dark:text-slate-400">ID: #{{ $stock->id ?? str_pad($index + 1, 4, '0', STR_PAD_LEFT) }}</div>
                                    </div>
                                </td>
                                ...
                                <td class="py-3 pr-0 align-top">
                                    <div class="space-y-2">
                                        <div class="flex items-baseline gap-2">
                                            ...
                                            <span class="text-xs text-slate-500 dark:text-slate-400">unit</span>
                                        </div>
                                        ...
                                        <div class="h-2 rounded-full bg-slate-100 border border-slate-200 overflow-hidden dark:bg-white/5 dark:border-[rgba(148,163,184,.12)]"
                                ...
                                <td colspan="5" class="py-12">
                                    <div class="max-w-xl mx-auto text-center space-y-6">
                                        ...
                                        <div class="relative mx-auto w-20 h-20">
                                            <div class="absolute inset-0 rounded-2xl bg-slate-50 border border-slate-200 grid place-items-center dark:bg-white/5 dark:border-[rgba(148,163,184,.12)]">
                                                <svg width="64" height="64" class="h-10 w-10 text-slate-500 dark:text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="mt-6">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        ...
                        <div class="flex items-center gap-3 text-sm">
                            <div class="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border bg-slate-100 border-slate-200 dark:bg-white/5 dark:border-[rgba(148,163,184,.12)]">
                                <svg width="20" height="20" class="h-4 w-4 text-slate-600 dark:text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
