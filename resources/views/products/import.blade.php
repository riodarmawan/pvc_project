...
@section('content')
    ...
    <div class="bg-white dark:bg-panelDark p-6 rounded-xl shadow-card">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
            <div>
                <h2 class="text-xl font-semibold text-slate-800 dark:text-slate-100">Impor Produk Massal</h2>
                <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Daftarkan banyak produk sekaligus menggunakan file Excel.</p>
            </div>
        ...
        <div class="border-t border-slate-200 dark:border-gray-700 pt-6">
            <form action="{{ route('admin.products.import.process') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 dark:text-slate-400 mb-2">Stok awal dari produk yang diimpor akan dicatat di cabang ini.</p>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-500 dark:text-slate-400 mb-2">Gunakan template yang sudah diunduh untuk menghindari error.</p>
                ...
                {{-- Tombol Submit --}}
                <div class="mt-8 flex justify-end border-t border-slate-200 dark:border-gray-700 pt-6">
                    <button type="submit"
                            class="px-8 py-2.5 bg-brand text-white font-medium text-sm leading-tight uppercase rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-0 transition duration-150 ease-in-out dark:bg-brandDark dark:hover:bg-indigo-700">
                        Mulai Proses Impor
                    </button>
                </div>
            </form>
