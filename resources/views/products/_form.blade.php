...
<div class="rounded-2xl border bg-white shadow-card border-slate-200">
    <div class="p-6 md:p-7 space-y-4">
        <div>
            ...
            <p class="text-sm text-slate-600">Informasi utama dan harga beli pertama (HPP) untuk produk ini.</p>
        </div>

        <div class="grid md:grid-cols-2 gap-4">
            <div class="space-y-2">
                <label for="sku" class="block text-xs uppercase tracking-wide text-slate-600">
            ...
            <div class="space-y-2">
                <label for="uom_id" class="block text-xs uppercase tracking-wide text-slate-600">
                    Satuan Unit (UOM)
                </label>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="space-y-2">
                    <label for="hpp" class="block text-xs uppercase tracking-wide text-slate-600">
                        Harga Beli (HPP)
                    </label>
                ...
                <div class="space-y-2">
                    <label for="selling_price" class="block text-xs uppercase tracking-wide text-slate-600">
                        Harga Jual
                    </label>
...
<div class="rounded-2xl border bg-white shadow-card border-slate-200">
    <div class="p-6 md:p-7 space-y-4">
        <div>
            ...
            <p class="text-sm text-slate-600">Pilih kategori yang sudah ada, atau buat yang baru.</p>
        </div>

        <div id="category-selection" class="space-y-3">
            <div class="space-y-2">
                <label for="category_id" class="block text-xs uppercase tracking-wide text-slate-600">
        ...
        <div id="new-category-form" class="space-y-3">
            <div class="grid md:grid-cols-2 gap-4">
                <div class="space-y-2">
                    <label for="new_category_name" class="block text-xs uppercase tracking-wide text-slate-600">
                        Nama Kategori Baru
                    </label>
                ...
                <div class="space-y-2">
                    <label for="new_category_code" class="block text-xs uppercase tracking-wide text-slate-600">
                        Kode Kategori Baru
                    </label>
...
<div class="rounded-2xl border bg-white shadow-card border-slate-200">
    <div class="p-6 md:p-7 space-y-4">
        ...
        <div class="grid md:grid-cols-2 gap-4">
            <div class="space-y-2">
                <label for="material" class="block text-xs uppercase tracking-wide text-slate-600">Material</label>
            ...
            <div class="space-y-2">
                <label for="series" class="block text-xs uppercase tracking-wide text-slate-600">Series</label>
            ...
            <div class="space-y-2">
                <label for="length_cm" class="block text-xs uppercase tracking-wide text-slate-600">Panjang (cm)</label>
            ...
            <div class="space-y-2">
                <label for="width_mm" class="block text-xs uppercase tracking-wide text-slate-600">Lebar (mm)</label>
            ...
            <div class="space-y-2">
                <label for="thickness_mm" class="block text-xs uppercase tracking-wide text-slate-600">Tebal (mm)</label>
            ...
            <div class="space-y-2">
                <label for="barcode" class="block text-xs uppercase tracking-wide text-slate-600">Barcode</label>
            ...
            <div class="md:col-span-2 space-y-2">
                <label for="notes" class="block text-xs uppercase tracking-wide text-slate-600">Catatan Tambahan</label>
                <textarea id="notes" name="notes" rows="3"
                          class="w-full bg-white border border-slate-200 rounded-xl p-3 text-sm
                                 focus:outline-none focus:ring-2 focus:ring-brand/40">{{ old('notes', $product->notes ?? '') }}</textarea>
            </div>
        </div>
    </div>
</div>
