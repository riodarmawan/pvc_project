@php
  $cart  = $cart  ?? [];
  $total = (float)($total ?? 0); // Simplified total (no discount)
  $paid  = (float)($paid ?? 0);
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
  ...
  <div class="p-6 space-y-4">
    ...
    <div class="space-y-3">
      ...
      {{-- TOTAL TAGIHAN (SIMPLIFIED - NO DISCOUNT) --}}
      <div class="flex justify-between items-center pt-2 pb-3 border-b-2 border-gray-200">
    ...
    <div class="mt-6">
      ...
      <button id="btn-verify-finalize" {{ !$canFinalize ? 'disabled' : '' }}
