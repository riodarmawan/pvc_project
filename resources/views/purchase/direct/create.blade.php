...
<div class="space-y-6">
 ...
 {{-- Supplier --}}
 <div class="space-y-2">
 <label for="supplier_id" class="block text-xs uppercase tracking-wide text-slate-600 ">Supplier</label>
 <div class="flex items-center gap-2">
 <select id="supplier_id" name="supplier_id" required
 class="w-full appearance-none bg-white border border-slate-200 rounded-xl h-11 px-3 pr-9 text-sm focus:outline-none focus:ring-2 focus:ring-brand/40 ">
 ...
 class="shrink-0 inline-flex items-center h-11 px-3 rounded-xl border hover:bg-slate-100 border-slate-200 ">
 Supplier Baru
 </a>
 </div>
 </div>
 ...
 {{-- Cabang --}}
 <div class="space-y-2">
 <label for="branch_id" class="block text-xs uppercase tracking-wide text-slate-600 ">Cabang Penerima</label>
 ...
 <label for="invoice_no" class="block text-xs uppercase tracking-wide text-slate-600 ">Nomor Invoice Supplier</label>
 ...
 <p class="text-sm text-slate-600 ">Tambahkan baris barang yang dibeli.</p>
 </div>
 <a href="{{ route('products.create') }}"
 class="inline-flex items-center h-10 px-3 rounded-xl border hover:bg-slate-100 border-slate-200 ">
 ...
 class="mt-2 inline-flex items-center h-10 px-4 rounded-xl border bg-slate-100 hover:bg-slate-200 border-slate-200 ">
 + Tambah Barang
 </button>
 </div>
 </div>
...
<template id="tpl-item-row">
 <div class="rounded-xl border bg-slate-50/60 border-slate-200 p-3 md:p-4 ">
 <div class="grid md:grid-cols-12 gap-3">
 {{-- Produk --}}
 <div class="md:col-span-5">
 <label class="block text-xs uppercase tracking-wide mb-1 text-slate-600 ">Produk</label>
 @isset($products)
 <select name="items[__INDEX__][product_id]" required
 class="w-full appearance-none bg-white border border-slate-200 rounded-lg h-10 px-3 pr-9 text-sm focus:outline-none focus:ring-2 focus:ring-brand/40 ">
 ...
 class="w-full bg-white border border-slate-200 rounded-lg h-10 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand/40 ">
 @endisset
 </div>

 {{-- Qty --}}
 <div class="md:col-span-3">
 <label class="block text-xs uppercase tracking-wide mb-1 text-slate-600 ">Qty</label>
 <input type="number" inputmode="decimal" step="0.01" min="0.01" placeholder="0.00"
 name="items[__INDEX__][qty]" required
 class="w-full bg-white border border-slate-200 rounded-lg h-10 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand/40 ">
 </div>

 {{-- Harga Satuan (harga beli aktual, wajib) --}}
 <div class="md:col-span-3">
 <label class="block text-xs uppercase tracking-wide mb-1 text-slate-600 ">Harga Satuan</label>
 <input type="number" inputmode="decimal" step="0.01" min="0" placeholder="0" required
...
(function(){
 ...
 if (prefill.price) row.querySelector('[name$="[price]"]').value = prefill.price;
