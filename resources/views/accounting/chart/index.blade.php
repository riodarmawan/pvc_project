          ...
          <tbody class="divide-y divide-slate-200">
            @forelse ($accounts as $account)
              <tr class="hover:bg-slate-50 transition-colors">
                ...
                <td class="py-3 pr-4 font-medium">{{ $account->name }}</td>
                <td class="py-3 pr-4">
                  @php
                    $typeColors = [
                  ...
                  @endphp
                  <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium {{ $tc[0] }}">
                    {{ $tc[1] }}
                  </span>
                </td>
                <td class="py-3 pr-4">
                ...
                <td class="py-3 pr-0">
                  <div class="flex items-center justify-end gap-2">
                    {{-- Edit --}}
                    <form method="POST" action="{{ route('accounting.chart.update', $account->id) }}">
                      @csrf
                      @method('PUT')
