...
@section('content')
 ...
 <h2 class="text-xl font-semibold mb-1 text-slate-800 ">Formulir Cabang Baru</h2>
 <p class="text-sm text-slate-500 mb-6">Setelah cabang dibuat, akun kasir akan dibuat secara otomatis.</p>
 ...
 {{-- Field: Nama Cabang --}}
 <div>
 <label for="name" class="block mb-2 text-sm font-medium text-gray-900 ">Nama Cabang <span class="text-red-500">*</span></label>
 ...
 {{-- Field: Kode Cabang --}}
 <div>
 <label for="code" class="block mb-2 text-sm font-medium text-gray-900 ">Kode Cabang <span class="text-red-500">*</span></label>
 ...
 <button type="submit"
 class="px-6 py-2.5 bg-brand text-white font-medium text-sm leading-tight uppercase rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-0 transition duration-150 ease-in-out ">
