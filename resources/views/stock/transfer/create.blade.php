...
<div class="space-y-6">
 ...
 class="ml-4 p-1 rounded-md hover:bg-emerald-100/70 ">
 ...
 <p class="text-slate-600 ">Kelola perpindahan stok antar cabang</p>
 </div>
 </div>
 <a href="{{ url()->previous() }}"
 ...
 <!-- Branch From -->
 <div>
 <label class="block text-xs uppercase tracking-wide mb-2 text-slate-600 ">
 ...
 placeholder="0.00" 
 required
 class="w-full bg-white border border-slate-200 rounded-xl h-11 px-3 pr-12 text-sm focus:outline-none focus:ring-2 focus:ring-brand/40 ">
 ...
 class="w-full bg-white border border-slate-200 rounded-xl p-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand/40 ">{{ old('notes') }}</textarea>
 </div>
 </div>
 ...
 <div class="text-sm inline-flex items-start gap-2 text-slate-600 ">
 <svg class="h-4 w-4 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
 <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/>
 </svg>
